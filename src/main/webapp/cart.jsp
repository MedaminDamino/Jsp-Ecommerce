                        ...
                        <c:choose>
                            <c:when test="${empty cartItems}">
                                <div class="text-center py-5 admin-card reveal p-5">
                                    ...
                                    <p class="text-muted mx-auto mb-4" style="max-width: 400px;">Looks like you haven't
                                        added anything to your cart yet. Explore our latest arrivals and find something
                                        you love!</p>
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${item.product.hasDiscount}">
                                                                            <div class="fw-bold text-dark">
                                                                                $${item.product.discountedPrice}</div>
                                                                            <small
                                    ...
                                    <div class="col-lg-4">
                                        <div class="admin-card sticky-top" style="top: 100px;">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <h3 class="fw-black text-primary mb-0">$${cartTotal}</h3>
                                            </div>
                                            ...
                                            <div class="text-center">
                                                <p class="x-small text-muted mb-0">
                                                    <i class="bi bi-lock-fill me-1"></i> Secure 256-bit SSL Encrypted
                                                    Payment
                                                </p>
                                            </div>
                                        </div>
