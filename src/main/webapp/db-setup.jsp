                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <% try (Connection conn=ConnectionFactory.getInstance().getConnection(); Statement
                                ...
                                stmt.addBatch("CREATE TABLE promotions (" + "id INT AUTO_INCREMENT PRIMARY KEY,"
                                + "title VARCHAR(200) NOT NULL," + "description TEXT," + "active BOOLEAN DEFAULT TRUE,"
                                + "discount_type VARCHAR(20) NOT NULL," + "discount_value DECIMAL(10,2) NOT NULL,"
                                + "end_date DATE NOT NULL)" ); stmt.addBatch("CREATE TABLE orders ("
