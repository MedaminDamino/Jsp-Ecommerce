                    ...
                    <div class="container py-5 reveal">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0 small text-uppercase fw-bold tracking-widest">Complete your
                                    order
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-8">
                                            ...
                                            <thead class="bg-light">
                                                <tr>
                                                    <th
                                                        ...
                                                        Product</th>
                                                    <th class="py-3 small text-uppercase text-muted fw-bold border-0">
                                                        Price
                                                    </th>
                                                    <th
                                ...
                                <div class="admin-card p-4 border-0 shadow-sm mb-4">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="x-small fw-bold text-uppercase text-muted mb-1">Full
                                                Name</label>
